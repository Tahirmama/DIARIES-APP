...
export const create = (
  ...
  try {
    ...
    const diary = exUser.createDiary({  //we use this method to save a new diary and associate it to a user account.
      title,
      type,
      createdAt: now,
      updatedAt: now,
...
export const addEntry = (
  //The addEntry methods create and correctly associate a new entry to a diary or update an existing entry’s data respectively.
  schema: any,
  req: Request
...
export const getEntries = ( //It retrieves a selected diary’s entries
  schema: any,
  req: Request
...
export const updateEntry = (schema: any, req: Request): Entry | Response => {
  //The updateEntry methods create and correctly associate a new entry to a diary or update an existing entry’s data respectively.
  try {
